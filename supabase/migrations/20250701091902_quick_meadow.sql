...
-- Insert sample apartments data only if the table is empty
INSERT INTO apartments (name, description, price_per_night, max_guests, bedrooms, bathrooms, size_sqft, images, amenities, features)
SELECT * FROM (VALUES
(
  'Ocean View Studio',
...
) AS new_apartments(name, description, price_per_night, max_guests, bedrooms, bathrooms, size_sqft, images, amenities, features)
